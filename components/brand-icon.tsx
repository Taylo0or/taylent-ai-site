...
const CLAUDE_CODE_D =
  "M12 2 2 7v10l10 5 10-5V7L12 2Zm0 2.3 7.4 3.7L12 11.7 4.6 8 12 4.3Zm-8 5.4 7 3.5v7.4l-7-3.5V9.7Zm16 7.4-7 3.5v-7.4l7-3.5v7.4Z";

const CODEX_D = "M9 5l-7 7 7 7m6-14l7 7-7 7";
  ...
  switch (brand) {
    case "anthropic":
      return (
        ...
        >
          <title>{label}</title>
          <path d={ANTHROPIC_D} fill="#D97757" fillRule="nonzero" />
        </svg>
      );
    ...
    case "gemini": {
      ...
      return (
        ...
        >
          ...
          <path d={GEMINI_D} fill={`url(#${g0})`} />
          <path d={GEMINI_D} fill={`url(#${g1})`} />
          <path d={GEMINI_D} fill={`url(#${g2})`} />
          <defs>
            <linearGradient
